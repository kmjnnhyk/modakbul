...
- `@modakbul/eslint-config`: `eslint` configurations (includes `eslint-config-next` and `eslint-config-prettier`)
- `@modakbul/database`: [Prisma](https://prisma.io/) ORM wrapper to manage & access your database
- `@modakbul/typescript-config`: `tsconfig.json`s used throughout the monorepo
